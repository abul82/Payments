...
//}
        ...
        credential, final PhoneCallbacksListener listener){
        ...
        public void resendVerificationCode(String phone, Activity otpActivity, PhoneAuthProvider.ForceResendingToken resendingToken){
            PhoneAuthProvider.getInstance().verifyPhoneNumber(
                    phone.trim(),
                    60,
                    TimeUnit.SECONDS,
